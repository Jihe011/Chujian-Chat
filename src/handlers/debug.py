...
class DebugCommandHandler:
    ...
    def process_command(self, command: str, current_avatar: str, user_id: str, chat_id: str = None, callback: Callable = None) -> Tuple[bool, str]:
        ...
        # 趣味命令
        elif cmd in ["fortune", "dream", "story", "joke", "roast", "horoscope", "advice", "quiz"]:
            if callback and chat_id:
                return True, self._generate_content_async(cmd, current_avatar, user_id, chat_id, callback)
            else:
                return True, self._generate_content(cmd, current_avatar, user_id)
    ...
    def _generate_content(self, content_type: str, avatar_name: str, user_id: str) -> str:
        ...
        try:
            ...
            content_type_methods = {
                ...
                'fortune': self.content_generator.generate_fortune,
                'dream': self.content_generator.generate_dream,
                'story': self.content_generator.generate_story,
                'joke': self.content_generator.generate_joke,
                'roast': self.content_generator.generate_roast,
                'horoscope': self.content_generator.generate_horoscope,
                'advice': self.content_generator.generate_advice,
                'quiz': self.content_generator.generate_quiz
            }
