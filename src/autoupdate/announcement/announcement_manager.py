...
class AnnouncementManager:
    ...
    def process_announcements(self, cloud_info: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            # 直接检查announcement字段（新格式：GitHub返回）
            if "announcement" in cloud_info:
                announcement = cloud_info["announcement"]
            ...
            # 兼容旧格式：version_info嵌套
            elif "version_info" in cloud_info and "announcement" in cloud_info["version_info"]:
