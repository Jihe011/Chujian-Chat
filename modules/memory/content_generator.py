...
class ContentGenerator:
    ...
    def __init__(self, root_dir: str, api_key: str, base_url: str, model: str, max_token: int, temperature: float):
        ...
        self.content_types = {
            ...
            'fortune': {'max_rounds': 5, 'command': '/fortune'},
            'dream': {'max_rounds': 10, 'command': '/dream'},
            'story': {'max_rounds': 8, 'command': '/story'},
            'joke': {'max_rounds': 5, 'command': '/joke'},
            'roast': {'max_rounds': 10, 'command': '/roast'},
            'horoscope': {'max_rounds': 5, 'command': '/horoscope'},
            'advice': {'max_rounds': 10, 'command': '/advice'},
            'quiz': {'max_rounds': 10, 'command': '/quiz'}
        }
    ...
    def _get_content_filename(self, content_type: str, avatar_name: str, user_id: str) -> str:
        ...
        # 判断是否为特殊内容类型（非日记）
        special_content_types = ['state', 'letter', 'list', 'pyq', 'gift', 'shopping', 'fortune', 'dream', 'story', 'joke', 'roast', 'horoscope', 'advice', 'quiz']
    ...
    def generate_fortune(self, avatar_name: str, user_id: str, save_to_file: bool = True) -> str:
        """生成今日运势"""
        return self._generate_content_wrapper('fortune', avatar_name, user_id, 5, save_to_file)

    def generate_dream(self, avatar_name: str, user_id: str, save_to_file: bool = True) -> str:
        """生成梦境记录"""
        return self._generate_content_wrapper('dream', avatar_name, user_id, 10, save_to_file)

    def generate_story(self, avatar_name: str, user_id: str, save_to_file: bool = True) -> str:
        """生成睡前故事"""
        return self._generate_content_wrapper('story', avatar_name, user_id, 8, save_to_file)

    def generate_joke(self, avatar_name: str, user_id: str, save_to_file: bool = True) -> str:
        """生成笑话"""
        return self._generate_content_wrapper('joke', avatar_name, user_id, 5, save_to_file)

    def generate_roast(self, avatar_name: str, user_id: str, save_to_file: bool = True) -> str:
        """生成吐槽内容"""
        return self._generate_content_wrapper('roast', avatar_name, user_id, 10, save_to_file)

    def generate_horoscope(self, avatar_name: str, user_id: str, save_to_file: bool = True) -> str:
        """生成星座运势"""
        return self._generate_content_wrapper('horoscope', avatar_name, user_id, 5, save_to_file)

    def generate_advice(self, avatar_name: str, user_id: str, save_to_file: bool = True) -> str:
        """生成角色建议"""
        return self._generate_content_wrapper('advice', avatar_name, user_id, 10, save_to_file)

    def generate_quiz(self, avatar_name: str, user_id: str, save_to_file: bool = True) -> str:
        """生成趣味问答"""
        return self._generate_content_wrapper('quiz', avatar_name, user_id, 10, save_to_file)
